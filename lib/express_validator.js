...
var expressValidator = function(options) {
  ...
  var defaults = {
    customValidators: {},
    customSanitizers: {},
    errorFormatter: function(param, msg, value, location, validatorCfg) {
      return {
   ...
   * @param {*} error
   */
  function errorFormatter({ param, msg, value, location, validatorCfg }) {
    return options.errorFormatter(param, msg, value, location, validatorCfg);
  }
